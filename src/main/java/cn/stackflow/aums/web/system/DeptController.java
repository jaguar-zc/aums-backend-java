...
public class DeptController {
    ...
    @OperLog(operModul = "部门",operType = Constants.OPER_TYPE_ADD,operDesc = "新增部门")
    @ApiOperation("创建部门")
    @PostMapping
    ...
    @OperLog(operModul = "部门",operType = Constants.OPER_TYPE_UPDATE,operDesc = "修改部门")
    @ApiOperation("修改部门")
    @PutMapping
    ...
    @OperLog(operModul = "部门",operType = Constants.OPER_TYPE_DELETE,operDesc = "删除部门")
    @ApiOperation("删除部门")
    @DeleteMapping("/{id}")
